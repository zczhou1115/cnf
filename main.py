...
def get_model(layer_num,neu_num,act_name):
    if layer_num == 3:
        neunumlist = [1,neu_num,neu_num,1]
        actlist = ['%s'%act_name,'%s'%act_name]
    if layer_num == 4:
        neunumlist = [1,neu_num,neu_num,neu_num,1]
        actlist = ['%s'%act_name,'%s'%act_name,'%s'%act_name]
    if layer_num == 5:
        neunumlist = [1,neu_num,neu_num,neu_num,neu_num,1]
...
hyperpara['samples'] = 51
hyperpara['layer_num'] = 3
hyperpara['neunum'] = 256
...
hyperpara['neunumlist'],hyperpara['actlist'] = get_model(hyperpara['layer_num'],hyperpara['neunum'],hyperpara['act_name'])
